            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Who We Are ?</h4>
                        <p>At Boss Up, we empower individuals and businesses to reach their full potential through innovation, expertise, and dedication.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Who We Do ?</h4>
                        <p>We provide cutting-edge solutions tailored to your needs, helping you stay ahead in a fast-paced digital world.</p>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6">
                    <div class="about__item">
                        <h4>Why Choose Us</h4>
                        <p>Our commitment to quality, reliability, and customer satisfaction ensures that you get the best results every time.</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="testimonial">
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-lg-6 p-0">
                    <div class="testimonial__pic set-bg" data-setbg="img/Boss-Up_Logo.png"></div>
                </div>
            </div>
        </div>
    </section>
